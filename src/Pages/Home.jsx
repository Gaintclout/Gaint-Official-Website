...
export default function Home() {
  ...
  return (
    <div className="font-century gothic text-gray-800 scroll-smooth w-full overflow-x-hidden">
            <Header />
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-end text-left text-white px-4 sm:px-6 md:px-24 max-w-4xl">
          {/* Glassmorphic Transparent Card */}
          <div className="bg-white/0 backdrop-blur-lg border border-white/10 rounded-3xl shadow-[0_8px_30px_rgba(0,0,0,0.3)] p-6 sm:p-8 md:p-10 lg:p-14 transition-all hover:bg-white/20 hover:shadow-[0_10px_40px_rgba(0,0,0,0.4)] ">
        ...
        text-[64px] sm:text-[96px] md:text-[120px] lg:text-[160px] xl:text-[200px]
...
">
  ...
  */}
      ...
      <section id="products" className="py-20 bg-transparent backdrop-blur-0">
        ...
        {/* Products Grid */}
        <div className="grid w-full md:grid-cols-3 sm:grid-cols-2 gap-6 sm:gap-8 px-4 sm:px-6 md:px-20">
          ...
          {[
            ...
            <a
              ...
              className="group relative backdrop-blur-sm bg-white/20 border border-white/30 rounded-2xl shadow-md p-6 sm:p-8 text-center hover:scale-105 hover:shadow-blue-300 transition-all overflow-hidden w-full max-w-sm mx-auto"
            >
          ...
          {/* 👉 LAST 2 CENTERED */}
          <div className="md:col-span-3 flex flex-col sm:flex-row justify-center gap-6 sm:gap-10 md:gap-20 w-full">
