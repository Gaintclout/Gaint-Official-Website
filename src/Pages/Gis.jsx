...
export default function Gis() {
    ...
    <div className="font-sans text-gray-800 scroll-smooth">
            ...
            <div className="space-y-4">
              {points.map((point, index) => (
                <div key={index} className="flex items-start gap-3">
                  {/* BULLET */}
                  <div
                    className="mt-1 h-4 w-4 sm:h-5 sm:w-5 rounded-md 
                bg-indigo-500/80 
                shadow-[0_0_12px_rgba(99,102,241,0.5)] flex-shrink-0"
                  ></div>
      ...
      <section className="relative w-full min-h-[80vh] overflow-hidden text-white flex flex-col items-center justify-center">
        ...
        "
            ...
            {/* LEFT DOWN */}
            <polyline
              points="390,230 400,250 410,230"
              stroke="#6366f1"
              strokeWidth="3"
              fill="none"
            />
            ...
            {/* CENTER UP */}
            <polyline
              points="540,270 550,250 560,270"
              stroke="#6366f1"
              strokeWidth="3"
              fill="none"
            />
            ...
            {/* RIGHT DOWN */}
            <polyline
              points="690,230 700,250 710,230"
              stroke="#6366f1"
              strokeWidth="3"
              fill="none"
            />
            ...
            {/* RIGHT VERTICAL */}
            <polyline
              points="990,270 1000,250 1010,270"
              stroke="#6366f1"
              strokeWidth="3"
              fill="none"
            />
          ...
          <p className="text-gray-300 text-sm mt-12 max-w-3xl text-center">
            The system transforms raw noise data into predictive intelligence
            through AI processing and visualizes it in actionable GIS maps for
            urban planning and enforcement decisions.
          </p>
        </div>
      </section>
      {/*===========graph ai brain =================*/}
  ...
  from-[#2a254d]/70 via-[#3b3560]/60 to-[#cbb9a5]/60"
        ></div>
        ...
        <div className="relative z-10 px-6 md:px-16 py-14 flex flex-col md:flex-row gap-10">
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-6">
              {/* CARD 1 */}
              <div
                className="bg-teal-300/20 backdrop-blur-md border border-teal-200/20 
        rounded-xl p-5 w-full"
              ...
              {/* CARD 2 */}
              <div
                className="bg-green-300/20 backdrop-blur-md border border-green-200/20 
        rounded-xl p-5 w-full"
              >
      ...
      <section className="relative w-full min-h-[90vh] overflow-hidden text-white">
        ...
        <div className="relative z-10 px-6 md:px-20 py-16 flex flex-col md:flex-row justify-between gap-10">
          ...
          <div className="w-full md:w-[55%]">
            ...
            {/* METRICS */}
            <div>
              <p className="text-gray-400 text-lg mb-4">Accuracy metrics:</p>
          ...
          <div className="w-full md:w-[40%] flex justify-center md:justify-end items-start mt-20">
            <div
              className="w-full max-w-md bg-black/60 backdrop-blur-md 
      ...
      <section className="relative w-full min-h-[90vh] bg-black text-white px-6 md:px-16 py-16">
        ...
        <p className="text-orange-400 text-lg md:text-xl mb-12">
          Same noise value, different meaning - day and night are treated
          differently.
        </p>
      ...
      <section className="relative w-full bg-gradient-to-b from-black via-[#020024] to-black text-white py-20 px-6 md:px-20 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <p className="text-gray-400 mb-16 max-w-xl text-sm md:text-lg leading-relaxed">
            Real-world scenarios where intelligence drives better municipal
            decisions.
          </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <div className="relative">
                ...
                <div className="relative border border-blue-500/30 rounded-xl p-6 bg-black/40 backdrop-blur-xl hover:scale-[1.03] hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                    Assess crowd capacity, traffic impact, and emergency access
                    routes before approving large public events.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative border border-blue-500/30 rounded-xl p-6 bg-black/40 backdrop-blur-xl hover:scale-[1.03] hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                    Identify high-risk areas and allocate patrol resources
                    effectively during nighttime hours.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative border border-blue-500/30 rounded-xl p-6 bg-black/40 backdrop-blur-xl hover:scale-[1.03] hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                    Model traffic flow patterns and optimize detour routes
              ...
              <div className="relative">
                ...
                <div className="relative border border-blue-500/30 rounded-xl p-6 bg-black/40 backdrop-blur-xl hover:scale-[1.03] hover:-translate-y-1 transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-400 leading-relaxed">
                    Analyze land use patterns and demographic data to inform
                    zoning decisions and business licensing.
                  </p>
                </div>
              </div>
            </div>
