...
<ScrollToTop />
  ...
  "
          ...
          <p
            className="
    text-m sm:text-xl md:text-2xl lg:text-3xl
    text-gray-200
    max-w-[700px]
    leading-relaxed
    animate-fadeIn
      ...
      <section className="relative bg-white py-20 px-6 lg:px-24 flex flex-col lg:flex-row items-center justify-between gap-10 overflow-hidden">
        ...
        <div className="lg:w-1/2">
          <div className="flex flex-col items-start gap-2 mb-6">
            ...
            {/* Name Section */}
            <h3 className="text-2xl  text-[#34A853] tracking-wide">
              {/* Mr. Srinivasa Rao Kolakaluri */}
            </h3>
          ...
          <button
            ...
            className="mt-9 px-6 py-2 text-sm  text-white rounded-full 
